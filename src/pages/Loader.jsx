...
// const Loader = () => {
//   return (
//     <div class="flex items-center justify-center w-full h-[100vh] text-gray-900 dark:text-gray-100 dark:bg-gray-950 absolute left-0">
//       <div>
...
const Loader = () => {
  return (
    <div className="flex items-center justify-center w-full h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-gray-900 dark:to-gray-950 absolute left-0 top-0">
      <div className="text-center">
        ...
        <div className="space-y-2">
          <h2 className="text-2xl md:text-4xl font-bold text-gray-800 dark:text-gray-100 tracking-wide">
            Loading
          </h2>
          ...
          <div className="w-48 h-1 bg-gray-200 dark:bg-gray-700 rounded-full overflow-hidden mt-6">
